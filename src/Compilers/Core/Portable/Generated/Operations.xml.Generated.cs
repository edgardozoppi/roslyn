...
namespace Microsoft.CodeAnalysis.Semantics
{
    ...
    {
        protected BaseSequenceExpression(ImmutableArray<ILocalSymbol> locals, bool isInvalid, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
                    base(OperationKind.BlockStatement, isInvalid, syntax, type, constantValue)
        {
            Locals = locals;
        }
    ...
    {
        public SequenceExpression(ImmutableArray<IOperation> expressions, IOperation value, ImmutableArray<ILocalSymbol> locals, bool isInvalid, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(locals, isInvalid, syntax, type, constantValue)
        {
    ...
    internal sealed partial class LazySequenceExpression : BaseSequenceExpression, ISequenceExpression
    {
        ...
        public LazySequenceExpression(Lazy<ImmutableArray<IOperation>> expressions, Lazy<IOperation> value, ImmutableArray<ILocalSymbol> locals, bool isInvalid, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(locals, isInvalid, syntax, type, constantValue)
        {
    ...
    {
        public BaseConditionalGotoStatement(ILabelSymbol target, bool jumpIfTrue, bool isInvalid, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(OperationKind.ConditionalGotoStatement, isInvalid, syntax, type, constantValue)
        {
            Target = target;
    ...
    {
        public ConditionalGotoStatement(IOperation condition, ILabelSymbol target, bool jumpIfTrue, bool isInvalid, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(target, jumpIfTrue, isInvalid, syntax, type, constantValue)
        {
            Condition = condition;
        }
        /// <summary>
    ...
    internal sealed partial class LazyConditionalGotoStatement : BaseConditionalGotoStatement, IConditionalGotoStatement
    {
        ...
        public LazyConditionalGotoStatement(Lazy<IOperation> condition, ILabelSymbol target, bool jumpIfTrue, bool isInvalid, SyntaxNode syntax, ITypeSymbol type, Optional<object> constantValue) :
            base(target, jumpIfTrue, isInvalid, syntax, type, constantValue)
        {
